...
python -m experiments.visualize_dynamic_modes --model_name ml_dmd --custom_name band_long_spec10 --data_path data\trajectories\nonlinear\closed_trig_large\long\test.npz
"""
...
if order_modes_by == "original":
    ...
    for pair in complex_pair_idx:
        avg_score = (scores_model[pair[0]] + scores_model[pair[1]]) / 2.0
        scores_model[pair[0]] = avg_score
        scores_model[pair[1]] = avg_score
